<template>
    <div
        class="fixed inset-0 bg-gradient-to-br from-purple-100 via-white to-purple-200 bg-opacity-80 flex items-center justify-center z-50"
    >
        <div
        ...
        >
            ...
            <div class="mb-6">
                <h3
                    class="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500 mb-2 tracking-tight"
                >
                    Start Secret Chat
                </h3>
